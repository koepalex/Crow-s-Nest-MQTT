...
namespace CrowsNestMQTT.UI.Services
{
    ...
    /// <summary>
    /// Contract: Message history navigation state
    /// </summary>
    public class MessageNavigationState
    {
        /// <summary>Current message list (read-only reference to existing data)</summary>
        public IReadOnlyList<Message> Messages { get; }

        /// <summary>Index of selected message (-1 if no messages)</summary>
        public int SelectedIndex { get; set; }

        /// <summary>Whether any messages exist for navigation</summary>
        public bool HasMessages => Messages.Count > 0;

        /// <summary>Navigate to next message (wrap-around)</summary>
        public void MoveDown();

        /// <summary>Navigate to previous message (wrap-around)</summary>
        public void MoveUp();

        /// <summary>Get currently selected message, or null if none</summary>
        public Message? GetSelectedMessage();

        /// <summary>Update message list when topic changes</summary>
