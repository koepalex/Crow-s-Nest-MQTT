...
```
tests/
├── UnitTests/                  # Unit tests (existing)
├── contract/                   # Contract tests (existing)
├── integration/                # Integration tests (new)
├── TestData/                   # Shared test data generators and utilities
│   ├── MqttTestDataGenerator.cs    # Test message generation with correlation data
│   └── MqttTestUtilities.cs        # MQTT broker and client test helpers
└── README.md                   # This file
```
...
- **Test Scenarios**:
  ...
  - Unicode/International characters (`корреляция-测试-🔗`)
